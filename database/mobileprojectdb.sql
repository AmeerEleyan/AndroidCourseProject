...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2022 at 06:01 PM
...
CREATE TABLE `bill` (
  ...
  `value_of_bill` int(11) DEFAULT NULL,
...
CREATE TABLE `customer` (
  ...
  `isGoldenCustomer` int(11) DEFAULT NULL COMMENT '0: not golden, 1: golden',
...
CREATE TABLE `employee` (
  ...
  `user_id` int(11) DEFAULT NULL,
  `employee_type` int(11) DEFAULT NULL COMMENT '2:admin, 3:cheff, 4:delivery_employee	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `login_table` (
  ...
  `login_type` int(11) DEFAULT NULL COMMENT '1:customer, 2:admin, 3:cheff, 4:delivery_employee'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `meal` (
  ...
  `meal_selling_price` int(11) DEFAULT NULL,
  `meal_cost_price` int(11) DEFAULT NULL,
